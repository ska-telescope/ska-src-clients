...
class Plan:
    ...
    def append_step(
        ...
        section_name: str,
        fqn: str,
        arguments: typing.Dict[typing.Any, typing.Any] = {},
        is_done: bool = False,
    ) -> None:
        """Append a step to the plan.

        :param str section_name: section name to run next step from
        (will skip other sections in between)
        ...
        for idx, step in enumerate(self.steps):
            ...
            if not is_done:
                if hasattr(step.fqn, "__self__"):  # bound method
                    print(
                        "{}: ({}) RUN bound method {}.{}.{} with parameters {}".format(
                            idx,
                            section_name,
                            fqn.__self__.__class__.__name__,
                            fqn.__name__,
                            fqn.__module__,
                            arguments,
                        )
                    ...
                    print(
                        "{}: ({}) RUN function {}.{} with parameters {}".format(
                            idx,
                            section_name,
                            fqn.__module__,
                            fqn.__name__,
                ...
                if hasattr(step.fqn, "__self__"):  # bound method
                    print(
                        "{}: ({}) RAN bound method {}.{}.{} with parameters {}".format(
                            idx,
                            section_name,
                            fqn.__self__.__class__.__name__,
                            fqn.__name__,
                    ...
                    print(
                        "{}: ({}) RAN function {}.{} with parameters {}".format(
                            idx,
                            section_name,
                            fqn.__module__,
                            fqn.__name__,
    ...
    def run(
        ...
        from (will skip other sections in between)
    ...
    def run_next_step(
        ...
        section_name, fqn, arguments, is_done = (
            ...
            current_step.is_done,
        )
        if hasattr(fqn, "__self__"):  # bound method
            logging.debug(
                "{}: ({}) Running function {}.{}.{} with parameters {}".format(
