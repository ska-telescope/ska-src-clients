...
from ska_src_clients.common.utility import remove_expired_tokens, get_authenticated_requests_session
...
class ClientFactory:
    ...
    def get_authn_client(self, is_authenticated=False):
        ...
        return self._get_client(service_name="authn-api", client=AuthenticationClient,
    ...
    def get_data_management_client(self, is_authenticated=False):
        ...
        return self._get_client(service_name="data-management-api", client=DataManagementClient,
                                is_authenticated=is_authenticated)

    def get_permissions_client(self, is_authenticated=False):
        """ Get a permissions client. """
        return self._get_client(service_name="permissions-api", client=PermissionsClient,
                                is_authenticated=is_authenticated)
